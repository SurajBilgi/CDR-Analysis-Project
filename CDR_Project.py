...
def create_app_ui():
    ...
    html.H1(children = 'CDR Analysis with Insights', id='Main_title', style={'textAlign': 'center','font-family': "Chalkduster,fantasy"}),
    ...
    ,style={'background-image':'url("/assets/background.jpg")','background-repeat': 'no-repeat','background-size': '100% 100%'})
